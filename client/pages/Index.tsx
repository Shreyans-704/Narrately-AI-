              ...
              <div className="pt-4 flex items-center gap-4 text-sm text-foreground/85">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-accent border-2 border-background flex items-center justify-center text-xs text-white font-bold"
                    >
                      {i}
                    </div>
                  ))}
                </div>
                <p>Join 1000+ creators already making magic</p>
              </div>
          ...
          <div className="flex items-center justify-between gap-6 mb-8">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-semibold text-foreground">
                Premium Shorts crafted by Narrately AI
              </h2>
            </div>
          </div>
          <ShortsVideoGrid />
